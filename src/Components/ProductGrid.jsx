...
export const ProductGrid = () => {
  ...
  const handleAddProducts = () => {
    ...
    setProducts((prev) =>
      prev.map((product) =>
        product.id === selectedProduct.id ? updatedProductDetails[0] : product
      )
    );
    ...
    <div className="p-4 bg-gray-100  w-full max-w-full ">
      ...
      <div className="space-y-4">
        ...
        {products.map((product, index) => (
          <div key={product.id} className="flex items-start space-x-4 p-2">
            {/* Serial Number */}
            ...
            <div className="relative flex items-center w-[500px]">
              <input
                ...
                className="w-[500px] p-2 pl-10 border border-gray-300 rounded-lg bg-white"
              />       
              ...
              />            
                ...
                <a
                  ...
                  onClick={(e) => {
                    ...
                    toggleSummaryVisibility(product.id); // Toggle visibility for this product
                  }}
                  ...
                  {product.variants.map((variant, variantIndex) => (
                    <div key={variantIndex}>
                      ...
                      <span class="flex items-center space-x-4">
                        <img src={circles} alt="circle" />
                        <p class="flex items-center border border-gray-300 bg-white rounded-full p-2 m-2 w-80 shadow-lg ">
                          <span>
                            Color/ {variant.color} - Size/ {variant.size}
                          </span>
                          
                        </p>
                        <button class="ml-4 text-gray-500 hover:text-red-500 focus:outline-none"  onClick={closevarinats}>
                            ✕
                          </button>
                      </span>
            ...
            {product.showDropdown ? (
              <div className=" space-x-2">
                <input
                  type="text"
                  value="0"
                  className="px-3 py-1 w-28 h-10 border border-gray-300 rounded"
                />
                <select
          ...
          {products.map((product) => (
            <div key={product.id}>          
              <div className="flex items-center space-x-4">           
                {/* Link to toggle the visibility for the product's variants */}
                <a
                  href="#"
                  onClick={(e) => {
                    e.preventDefault(); // Prevent default link behavior
                ...
                <div>
                  {product.variants.map((variant, variantIndex) => (
                    <div key={variantIndex}>
                      ...
                      <span class="flex items-center space-x-4">
                        <img src={circles} alt="circle" />
                        <p class="flex items-center border border-gray-300 bg-white rounded-full p-2 m-2 w-80 shadow-lg justify-between">
                          <span>
                            Color/ {variant.color} - Size/ {variant.size}
                          </span>
